              ...
              <Table className="w-full border-collapse border border-gray-300">
                <TableHeader>
                  <TableRow className="border-b border-gray-300">
                    <TableHead className="bg-gray-100 font-semibold text-primary px-3 py-3">Model Name</TableHead>
                    <TableHead className="bg-gray-100 font-semibold text-primary px-3 py-3">Use</TableHead>
                    <TableHead className="bg-gray-100 font-semibold text-primary px-3 py-3">Served</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
